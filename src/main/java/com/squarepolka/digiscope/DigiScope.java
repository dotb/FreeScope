...
//        PlotParser plotParser = PlotParser.newPlotParser("test_data/WaveData_test_arc.csv");
        PlotParser plotParser = PlotParser.Companion.newPlotParser("test_data/WaveData422_flipflop_100us_1v_800us.csv");
...
//        System.out.println(plotPointRecording.getBinaryDigits());
        ...
        plotPointRecording.printHorizontalGraph();
    }
